namespace CustomerManagement.Models
{
	public static class RepositoryHelper
	{
		...
		public static V客戶統計資料Repository GetV客戶統計資料Repository()
		{
			var repository = new V客戶統計資料Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static V客戶統計資料Repository GetV客戶統計資料Repository(IUnitOfWork unitOfWork)
		{
			var repository = new V客戶統計資料Repository();
